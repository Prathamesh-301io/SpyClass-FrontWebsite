...
<div class="card card-default color-palette-box">
    ...
    <div class="card-body">
        <form action="<?= base_url($panel) ?>/invoice/save" id="invoice_form" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-6 col-sm-12 pl-5">
                            <div class="form-group row">
                                <label for="invoice_no" class="col-sm-4 col-form-label">Invoice Number <span style="color: red;">*</span></label>
                                <div class="col-sm-8">
                                        ...
                                        <table class="table" id="InvoiceTable" style="border: 1px solid rgba(203, 213, 225, 1);">
                                            ...
                                            <tbody>
                                                <tr id="first_tr_row">
                                                    ...
                                                    <td> <select class="form-control form-control-border floatOnly" id="units" name="units[]" value="" placeholder="" required>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // if session exits 
        <?php if (session()->has('HaveFurhterAccess')) {  ?>
