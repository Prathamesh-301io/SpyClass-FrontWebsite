<div class="" id="InvoicePDF" style="font-family: Arial, sans-serif; width: 100%; margin: 0 auto;">
    ...
    <table border="1" cellspacing="0" cellpadding="5" style="width: 100%; border-collapse: collapse;">
        <tr>
            <td colspan="6" style="vertical-align: top; padding: 1rem;">
                ...
                <strong>Email:</strong> <?= $CompanyData['company_email']? $CompanyData['company_email']: '-' ?><br>
                <strong>PAN No:</strong> <?= $CompanyData['pan_no'] ? $CompanyData['pan_no'] : '-'; ?>
            </td>
            <td colspan="5" style="vertical-align: top; padding: 1rem;">
                <table style="width: 100%;">
                    <tr>
                        <td colspan="5"><strong>Invoice No.</strong></td>
                        <td colspan="2"><strong>:</strong></td>
                        <td colspan="5"><?= $GetInvoiceData['invoice_no']  ?></td>
                    </tr>
                    <tr>
                        <td colspan="5"><strong>Invoice Date</strong></td>
                        <td colspan="2"><strong>:</strong></td>
                        <td  colspan="5"><?= $GetInvoiceData['invoice_date'] ? date('d M Y', strtotime($GetInvoiceData['invoice_date'])) : '-'; ?></td>
                    </tr>
                    <tr>
                        <td colspan="5"><strong>Invoice Due Date</strong></td>
                        <td colspan="2"><strong>:</strong></td>
    ...
    <table border="1" cellspacing="0" cellpadding="5" style="width: 100%; margin-top: 10px; border-collapse: collapse;">
        <tr>
            ...
            <td colspan="2" style="vertical-align: top; padding: 1rem; text-align: left;">
                <strong>Note:</strong> 
                 <?= $GetInvoiceData['note']; ?>
            </td>
        </tr>
        <tr>
            <td style="vertical-align: top; padding: 1rem;">
                ...
                Account Name: <?= $CompanyData['acc_holder_name'] ? $CompanyData['acc_holder_name'] :'-' ?><br>
                Bank Name: <?=  $CompanyData['bank_name'] ? $CompanyData['bank_name'] :'-' ?><br>
                A/C No - <?= $CompanyData['account_number'] ? $CompanyData['account_number'] :'-' ?><br>
                IFSC Code - <?= $CompanyData['ifsc_code'] ? $CompanyData['ifsc_code'] :'-' ?>, Branch - <?= $CompanyData['bank_branch'] ? $CompanyData['bank_branch'] :'-' ?>
            </td>
            <td style="vertical-align: top; padding: 1rem; text-align: center;">
