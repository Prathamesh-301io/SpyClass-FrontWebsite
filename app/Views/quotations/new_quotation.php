...
<div class="card card-default color-palette-box">
    ...
    <div class="card-body">
        <form action="<?= base_url($panel) ?>/quotations/save" id="invoice_form" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="card invoice-form">
                <div class="card-header invoice-header-bg" style="border-radius:16px 16px 0px 0px">
                    <h3 class="text-center pt-1"><strong>Quotation</strong></h3>
                </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-6 col-sm-12 pl-5">
                            <div class="form-group row">
                                <label for="invoice_no" class="col-sm-4 col-form-label">Quotation Number <span style="color: red;">*</span></label>
                                <div class="col-sm-8">
                                    <input type="text" name="unique_invoice_no" class="form-control form-control-border" id="invoice_no" value="<?= !empty($GetInvoiceData[0]['invoice_no']) ? $GetInvoiceData[0]['invoice_no'] : "" ?>" placeholder="Enter quotation number" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="invoice_date" class="col-sm-4 col-form-label">Quotation Date <span style="color: red;">*</span></label>
                                <div class="col-sm-8">
                    ...
                    <div class="row pt-3">
                        ...
                        <div class="col-md-6 col-sm-12 pl-5">
                            <div class="form-group row d-none">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-border" id="dispatch_doc_no" name="dispatch_doc_no" value="<?= !empty($GetInvoiceData[0]['despatch_doc_no']) ? $GetInvoiceData[0]['despatch_doc_no'] : "" ?>" placeholder="Enter dispatch document number" >
                                </div>
                            </div>
                            <div class="form-group row d-none">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-border" id="dispatched_thorugh" name="dispatched_thorugh" value="<?= !empty($GetInvoiceData[0]['dispatched_through']) ? $GetInvoiceData[0]['dispatched_through'] : "" ?>" placeholder="Mention dispatched through" >
                                </div>
                            </div>
                            <div class="form-group row d-none">
                    ...
                    <div class="row pt-3">
                        <div class="col-md-12 px-0">
                            <div class="card">
                                ...
                                <?= view("quotations/sahil_cargo_table") ?>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2 mb-2 divider-line"></div>
    ...
    <?= view("quotations/add_client") ?>
    <?= view("quotations/add_gst") ?>
</div>
<?= $this->endSection() ?>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('keyup', '.units', function () {
            ...
            if (input.length > 0) {
                $.ajax({
                    url: 'quotations/getProductsUnit',
                    data: { search: input },
                    dataType: 'json',
                    success: function (data) {
                        var suggestions = data.filter(function (item) {
    ...
    function fetchCompanyDetails(companyId, type) {
        if (companyId) {
            $.ajax({
                url: `<?= site_url($panel . '/quotations/getCompanyDetails') ?>`,
                type: 'post',
                data: {
                    companyId: companyId,
                    type: type,
    ...
    $(document).ready(function() {
        $("#invoice_form").on("submit", function(event) {
            ...
            submitButton.html("Creating Quotation... <i class='fa fa-spinner fa-spin'></i>");
        });
    });
