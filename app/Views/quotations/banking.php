    ...
    <div class="card-body">
        <div class="card invoice-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="bank_name" id="bank_name" value="<?=  !empty($InvoiceBankerDetails[0]['bank_name']) ? $InvoiceBankerDetails[0]['bank_name'] : ''  ?>" placeholder="Enter bank name" readonly >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="account_holder_name">Account holder name</label>
                                        <input type="text" class="form-control" name="account_holder_name" id="account_holder_name" value="<?= !empty($InvoiceBankerDetails[0]['acc_holder_name']) ? $InvoiceBankerDetails[0]['acc_holder_name'] : ''  ?>"  placeholder="Enter account holder name" readonly >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="account_number">Account number</label>
                                        <input type="text" class="form-control" name="account_number" value="<?= !empty($InvoiceBankerDetails[0]['account_number']) ? $InvoiceBankerDetails[0]['account_number'] : ''  ?>" id="account_number" placeholder="Enter account number" readonly >
                                    </div>
                                </div>
                                <!-- <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="c_account_number">Confirm account number</label>
                                        <input type="text" class="form-control" name="c_account_number" value="<?= !empty($InvoiceBankerDetails[0]['account_number']) ? $InvoiceBankerDetails[0]['account_number'] : ''  ?>"  id="c_account_number" placeholder="Confirm account number" readonly >
                                    </div>
                                </div> -->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="ifsc_code">IFSC code</label>
                                        <input type="text" class="form-control" name="ifsc_code" id="ifsc_code" value="<?=  !empty($InvoiceBankerDetails[0]['ifsc_code']) ? $InvoiceBankerDetails[0]['ifsc_code'] : ''  ?>" placeholder="Enter IFSC code" readonly >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="ifsc_code">Bank branch</label>
                                        <input type="text" class="form-control" name="bank_branch" id="bank_branch" value="<?=  !empty($InvoiceBankerDetails[0]['bank_branch']) ? $InvoiceBankerDetails[0]['bank_branch'] : ''  ?>" placeholder="Enter bank branch" readonly >
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="upi_id" id="upi_id" value="<?=  !empty($InvoiceBankerDetails[0]['upi_id']) ? $InvoiceBankerDetails[0]['upi_id'] : ''  ?>" placeholder="example@upi" readonly >
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="card-footer py-4 text-right" style="border-radius: 0px 0px 16px 16px">
                ...
                <a href="<?= site_url($panel."/quotations/share") ?>" type="button" class="btn btn-tool text-white action-btn">Save & Next</a>
            </div>
        </div>
    </div>
</div>
