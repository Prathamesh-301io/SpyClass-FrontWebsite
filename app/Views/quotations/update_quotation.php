...
<div class="card card-default color-palette-box">
    ...
    <div class="card-body">
        <form action="<?= base_url($panel) ?>/quotations/update" id="invoice_form" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group row">
                                <label for="invoice_no" class="col-sm-4 col-form-label">Quotation No. <span style="color: red;">*</span></label>
                                <div class="col-sm-8">
...
<script>
    ...
    $(document).ready(function() {
        ...
        <?php if ($invoice_sender_id != $_ENV['SAHIL_CARGO_ID']) {  ?>
            ...
            <tr>
                ...
                <td> <select class="form-control form-control-border floatOnly" id="units_${rowCountSet}" name="units[]" placeholder="" required>
                    <option value="">select units</option>
                    <?php foreach ($aUnits as $unit) { ?>
                        <option value="<?= $unit['unit_notation']; ?>"><?= $unit['unit_notation']; ?></option>
                    <?php } ?>
                </select></td>
    ...
    $(document).ready(function() {
        $("#invoice_form").on("submit", function(event) {
            ...
            submitButton.html("Updating Quotation... <i class='fa fa-spinner fa-spin'></i>");
        });
    });
