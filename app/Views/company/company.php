					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" name="contact_no" class="form-control" pattern="[0-9, ]*" title="Only numbers, commas, and spaces are allowed"  id="company_contact_no" placeholder="Enter contact number" value="<?= isset($aCompanyData['id']) ? $aCompanyData['contact_no'] : '' ?>">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label for="company_gstin">PAN </label>
								<input type="text" name="pan_no" class="form-control" id="pan_no" placeholder="Enter PAN" value="<?= isset($aCompanyData['id']) ? $aCompanyData['pan_no'] : '' ?>">
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
...
<?= view('company/validation');  ?>
	<script type="text/javascript">
		$('#company_contact_no').on('input', function() {
