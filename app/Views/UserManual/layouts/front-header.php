      ...
      <header class="bg-white sticky top-0 shadow-md z-50">
         <div
            ...
            <div class="hidden lg:flex space-x-2 xl:space-x-4">
               ...
               <a class="font-semibold py-2 px-4 rounded-lg <?= ($currentPage == 'usermanual') ? 'text-purple-700 font-bold  bg-purple-100' : 'text-gray-700 hover:bg-gray-100'; ?>" href="<?php echo base_url('usermanual'); ?>">User Manual</a>
            </div>
      ...
      <div class="hidden navbar-menu relative z-50 transition duration-300">
         ...
         <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto transition duration-300">
            ...
            <div class="flex flex-col space-y-3">
               ...
               <a class="font-semibold py-2 px-4 rounded-full <?= ($currentPage == 'usermanual') ? 'bg-purple-700 text-white' : 'text-gray-700 hover:bg-gray-100'; ?>" href="<?php echo base_url('usermanual'); ?>">User Manual</a>
            </div>
