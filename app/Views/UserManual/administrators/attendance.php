    ...
    <div class="max-w-5xl mx-auto px-4">
        ...
        <div id="students-attendance" class="mb-12">
            ...
            <p class="text-gray-700 mb-4">
                Administrators can mark attendance by filtering students based on class and section. If the administrator is assigned to a particular class, the list of students will be shown. 
                The default status for all students is set to "Present" for quick entry. Administrators can mark a student as "Absent", "Late", or "Half Day" if needed.
                If attendance has already been submitted, it will display a message: "Attendance Already Submitted. You Can Edit Record".
            </p>
            <p class="text-gray-700 mb-4">
                Administrators can also mark the entire class as "Holiday" with a single click, saving time when the whole class is absent. 
        ...
        <div id="attendance-by-date" class="mb-12">
            ...
            <p class="text-gray-700 mb-4">
                This section allows administrators to view the attendance of students filtered by class, section, and date. The UI displays the status as "Present", "Absent", 
        ...
        <div id="approve-leave" class="mb-12">
            ...
            <p class="text-gray-700 mb-4">
                Administrators can approve or reject student leave applications from this section. Only leaves of students assigned to the respective class will be displayed. 
