   ...
   <div class="main">
      ...
      <header class="bg-white sticky top-0 shadow-md z-50">
         <div
            ...
            <!-- Logo -->
            <a class="text-3xl font-semibold leading-none" href="<?php echo base_url(); ?>">
               <img class="h-10-0" src="<?php echo base_url(); ?>/public/fassets/imgs/logos/SpyClass.png" alt="spy class logo" style="width: 200px !important" />
            </a>
            ...
            <div class="hidden lg:flex space-x-2 xl:space-x-4">
               ...
               <a class="font-semibold py-2 px-4 rounded-full <?= ($currentPage == 'aboutus') ? 'bg-purple-700 text-white' : 'text-gray-700 hover:bg-gray-100'; ?>" href="<?php echo base_url('aboutus'); ?>">About Us</a>
               <a class="font-semibold py-2 px-4 rounded-full <?= ($currentPage == 'blogs') ? 'bg-purple-700 text-white' : 'text-gray-700 hover:bg-gray-100'; ?>" href="#">Blogs</a>
               <a class="font-semibold py-2 px-4 rounded-full <?= ($currentPage == 'faq') ? 'bg-purple-700 text-white' : 'text-gray-700 hover:bg-gray-100'; ?>" href="#">FAQ</a>
               <a class="font-semibold py-2 px-4 rounded-full <?= ($currentPage == 'contact') ? 'bg-purple-700 text-white' : 'text-gray-700 hover:bg-gray-100'; ?>" href="#">Contact Us</a>
            </div>
