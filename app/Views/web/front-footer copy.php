<footer class="bg-[#141A24]">
         <div
            class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24"
            >
            <div class="grid grid-cols-1 lg:gap-36 md:gap-36 gap-5 lg:grid-cols-3">
               <div>
                  <div class="flex justify-start text-white sm:justify-start">
                     About SpyClass
                  </div>
                  <p
                     class="max-w-md mx-auto mt-6 leading-relaxed text-left text-gray-400 sm:max-w-xs sm:mx-0 sm:text-left"
                     >
                     SpyClass ERP is an advanced school management system designed to streamline operations and enhance communication between schools, students, and parents.
                  </p>
                  <ul class="flex justify-start gap-6 mt-8 md:gap-8 sm:justify-start">
                     <li>
                        <a
                           ...
                           target="_blank"
                           class="text-[#8849AE] transition hover:text-[#8849AE]/75"
                           >
               ...
               <div
                  class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:col-span-2 md:grid-cols-3"
                  >
                  ...
                  <div class="text-left sm:text-left">
                     <p class="text-lg font-medium text-white">Help</p>
                     <nav class="mt-8">
                        <ul class="space-y-4 text-sm">
         ...
         <div class="text-center text-sm py-4 bg-white text-black mt-10">
          Zeplinix Techologies  © <?php echo date('Y') ?> All Rights Reserved  
         </div>
      </footer>
      <!-- End .main -->
       <div id="preloader-active">
           <div class="preloader flex-1 content-center">
             <div class="logo absolute inset-y-2/4 jump">
               <img src="<?php echo base_url(); ?>/public/fassets/imgs/logos/SpyClass.png" alt="" />
               <h3 class="text-lg font-semibold text-center"><b>S-</b>Secure <b>P-</b>Productive <b>Y-</b>YouthCentric</h3>
             </div>
           </div>
         </div>
      <!--Import Vendor Js-->
