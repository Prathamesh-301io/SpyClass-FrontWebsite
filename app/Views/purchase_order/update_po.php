...
<div class="card card-default color-palette-box">
    ...
    <div class="card-body">
        <form action="<?= base_url($panel) ?>/po/update" id="invoice_form" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group row">
                                <label for="invoice_no" class="col-sm-4 col-form-label">PO No. <span style="color: red;">*</span></label>
                                <div class="col-sm-8">
                                        ...
                                        <table class="table" style="border: 1px solid rgba(203, 213, 225, 1);">
                                            ...
                                            <tbody>
                                                <tr id="first_tr_row">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-control-border description_of_goods" id="description_of_goods" value="" name="description_of_goods[]" placeholder="Description" required>
...
<script>
    ...
    $(document).ready(function() {
        ...
        <?php if ($invoice_sender_id != $_ENV['SAHIL_CARGO_ID']) {  ?>
            ...
            <tr>
                ...
                <td>
                    <input type="hidden" class="form-control form-control-border" id="description_of_goods_${rowCount}" name="session_invoice_master_id[]" value="${item.id}" placeholder="Description">
                    <input type="text" class="form-control form-control-border description_of_goods" id="description_of_goods_${rowCount}" name="description_of_goods[]" value="${item.description_of_goods}" placeholder="Description" autocomplete="off">
                    <div class="autocomplete-suggestions" style="display:none; border: 1px solid #ddd; position: absolute; max-height: 150px; overflow-y: auto;"></div>
                </td>
                <td>
                    <input type="text" class="form-control form-control-border hsn_no" id="hsn_no_${rowCount}" name="hsn_no[]" value="${item.hsn_no}" placeholder="HSN" autocomplete="off">
                    <div class="autocomplete-suggestions" style="display:none; border: 1px solid #ddd; position: absolute; max-height: 150px; overflow-y: auto;"></div>
                </td>
                <td>
                    <input type="text" class="form-control form-control-border" id="packing_tr${rowCount}" name="packing_tr[]" value="${item.packing}" placeholder="Packing" autocomplete="off">
                    </td>
                <td><input type="number" class="form-control form-control-border floatOnly" id="quantity_${rowCount}" name="quantity[]" value="${item.quantity}" placeholder="Quantity" autocomplete="off"></td>
                <td>
                    <input type="text" class="form-control form-control-border units" id="units_${rowCount}" name="units[]" value="${item.unit}" placeholder="" required autocomplete="off">
                    <div class="autocomplete-suggestions" style="display:none; border: 1px solid #ddd; position: absolute; max-height: 150px; overflow-y: auto;"></div>
                </td>
                <td>
                    <input type="text" class="form-control form-control-border floatOnly" id="rate_${rowCount}" name="rate[]" value="${item.rate}" placeholder="Rate" autocomplete="off">
                </td>
                <td>
                    <input type="text" class="form-control form-control-border floatOnly" id="amount_${rowCount}" name="amount[]" value="${item.amount}" placeholder="Amount" autocomplete="off">
                </td>
            ...
            $('#InvoiceTableData tbody').append(newRow);
                ...
                const unitSelect = $('#units_' + rowCountSet);
        ...
        $('#add_new_table_row').click(function() {
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control form-control-border description_of_goods" id="description_of_goods_${rowCount}" name="description_of_goods[]" value="" placeholder="Description" autocomplete="off">
                    <div class="autocomplete-suggestions" style="display:none; border: 1px solid #ddd; position: absolute; max-height: 150px; overflow-y: auto;"></div>
                </td>
                <td>
                    <input type="text" class="form-control form-control-border hsn_no" id="hsn_no_${rowCount}" name="hsn_no[]" value="" placeholder="HSN" autocomplete="off">
                    <div class="autocomplete-suggestions" style="display:none; border: 1px solid #ddd; position: absolute; max-height: 150px; overflow-y: auto;"></div>
                </td>
                <td>
                    <input type="text" class="form-control form-control-border" id="packing_${rowCount}" name="packing_tr[]" value="" placeholder="Packing" autocomplete="off">
                    <div class="autocomplete-suggestions" style="display:none; border: 1px solid #ddd; position: absolute; max-height: 150px; overflow-y: auto;"></div>
                </td>
                <td>
                    <input type="number" class="form-control form-control-border" id="quantity_${rowCount}" name="quantity[]" value="" placeholder="Qty" autocomplete="off">
                </td>
                <td> 
                    <input type="text" class="form-control form-control-border units" id="units_${rowCount}" name="units[]" value="" placeholder="Unit" required autocomplete="off">
                    <div class="autocomplete-suggestions" style="display:none; border: 1px solid #ddd; position: absolute; max-height: 150px; overflow-y: auto;">
                </div>
                </td>
                <td>
    ...
    $(document).ready(function() {
        $("#invoice_form").on("submit", function(event) {
            ...
            submitButton.html("Updating PO... <i class='fa fa-spinner fa-spin'></i>");
        });
    });
        ...
        $(document).ready(function() {
            ...
            invoiceDetails.forEach((item) => {
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control form-control-border s_invoice_date date-picker" id="s_invoice_date_${updateRow}" value="${item.sc_date}" name="s_invoice_date[]" required></td>
    ...
    $('#s_add_new_table_row').click(function() {
        ...
        const newRow = `
                    ...
                    <td><input type="text" class="form-control form-control-border s_invoice_date date-picker" id="s_invoice_date_${SahilrowCount}" value="<?= date('d-m-Y') ?>" name="s_invoice_date[]" required></td>
